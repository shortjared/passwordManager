...
$cur = $this->installed ('passwordManager', $appconf['Admin']['version']);
...
$page->title = 'Installing app: passwordManager';
...
$error = false;
$sqldata = sql_split (file_get_contents ('apps/passwordManager/conf/install_' . $driver . '.sql'));
